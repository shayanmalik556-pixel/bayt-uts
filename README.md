...
1. **Netlify Drop** – Go to [app.netlify.com/drop](https://app.netlify.com/drop), drag the project folder, and get a public URL.
2. **GitHub Pages** – Push the repo to GitHub, enable Pages for the branch, and use the generated `https://<user>.github.io/<repo>/` link.
3. **Zip** – Zip the folder and send it; the client can open `index.html` in a browser.
